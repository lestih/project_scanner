...
Проект представляет собой многопоточный антивирусный сканер для Windows, который проверяет файлы из заданной директории по базе MD5-хешей известных вредоносных программ.
